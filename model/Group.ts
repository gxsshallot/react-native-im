...
export interface Interface {
     ...
     */
    setMembers(toAdd?: string[], toRemove?: string[]): Promise<void>;
     ...
     */
    setAvoid(isAvoid: boolean): Promise<boolean>;
     ...
     * @param isShow 新的显示状态。
     */
    setShowMembersName(isShow: boolean): Promise<boolean>;
     ...
     */
    setAllowInvite(isAllowInvite: boolean): Promise<boolean>;
